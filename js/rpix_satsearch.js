        ...
        $('.img-preview').append(
            '<div class="item">' +
                ...
                '<div class="result-overlay">' +
                    ...
                    '<span>Link:</span>' +
                    `<a target="_blank"class="btnDD" href="https://viewer.remotepixel.ca/?sceneid=${res[i].sceneID}"><i style="color:#FFF" class="fa fa-eye"></i></a>` +
        ...
        $('.img-preview').append(
            '<div class="item">' +
                ...
                '<div class="result-overlay">' +
                    ...
                    '<span>Link:</span>' +
                    `<a target="_blank"class="btnDD" href="https://viewer.remotepixel.ca/?sceneid=${res[i].id}"><i style="color:#FFF" class="fa fa-eye"></i></a>` +
...
$('#newVersion').on('hidden.bs.modal', function () {
  initMap();
});
