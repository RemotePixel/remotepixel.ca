    ...
    $.fn.extend({
        beforeAfter: function(_before_,_after_,options){
			...
			return this.each(function(){
		        ...
		        $(obj).append('<h4 id="lt-text'+randID+'"></h4>');
		        $(obj).append('<h4 id="rt-text'+randID+'"></h4>');

		        w = $(obj).width();
		        $('#lt-text'+randID).css({'z-index':'20','position':'absolute','top':'10px','right': w - parseInt( $('#dragwrapper'+randID).css('left'))}).css('right', '+=' + o.textOffset + 'px');
		        $('#rt-text'+randID).css({'z-index':'20','position':'absolute','top':'10px','left': parseInt( $('#dragwrapper'+randID).css('left'))}).css('left', '+=' + o.textOffset + 'px');
				...
				if (o.changeOnResize){
				    ...
				    $(window).on('orientationchange pageshow resize', function () {
				        ...
				        $('#lt-text'+randID).css({'right': w - parseInt( $('#dragwrapper'+randID).css('left'))}).css('right', '+=' + o.textOffset + 'px');
				        $('#rt-text'+randID).css({'left': parseInt( $('#dragwrapper'+randID).css('left'))}).css('left', '+=' + o.textOffset + 'px');
